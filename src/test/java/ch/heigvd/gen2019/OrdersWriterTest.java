...
public class OrdersWriterTest {
  ...
  @Test
  public void NoOrder() {
    assertEquals("{\"orders\": []}", new JsonWriter(new Orders()).getContents());
  }

  @Test
  public void OneOrder() {
    String order111 = "{\"id\": 111, \"products\": []}";
    assertEquals("{\"orders\": [" + order111 + "]}", new JsonWriter(orders).getContents());
  }
  ...
  public void TwoOrders() {
    ...
    assertEquals("{\"orders\": [" + order111Json + ", " + order222Json + "]}",
        new JsonWriter(orders).getContents());
  }
  ...
  public void OneOrderWithOneProduct() {
    ...
    assertEquals("{\"orders\": [" + order111Json + "]}", new JsonWriter(orders).getContents());
  }

  @Test
  public void OneOrderWithOneProductNoSize() {
    order111.AddProduct(new Product("Pot", Color.RED, null, 16.50, "SGD"));
